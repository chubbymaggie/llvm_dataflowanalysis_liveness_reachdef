...
namespace {
	template <class FlowType>
		class ReachAnalysis : public IDFA<FlowType> {
			public:
				...
				void initInstGenKill(Instruction *ii);
				//generate the gen and kill set for each block
				void initGenKill(BasicBlock *Bi, BasicBlock *Pi);
				//get the boundary condition
				BitVector* getBoundaryCondition(int len, Function &F);
	 ...
	 */
	template <class FlowType>
	void ReachAnalysis<FlowType>::initInstGenKill(Instruction *ii) {
	 ...
	 */
	template <class FlowType>
	void ReachAnalysis<FlowType>::initGenKill(BasicBlock *Bi, BasicBlock *Pi) {
	 ...
	 */
	template <class FlowType>
	BitVector* ReachAnalysis<FlowType>::getBoundaryCondition(int len, Function &F) {
