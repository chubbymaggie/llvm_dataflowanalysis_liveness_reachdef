// CS380C S14 Assignment 3: reach.cpp
// 
...
namespace {
	class ReachDef : public FunctionPass {
		public:
			static char ID;
			...
			virtual bool runOnFunction(Function &F) {
				...
				reachAnly->analysis(domain, F, true);

				Annotator<Value *> annot(reachAnly->BBtoInfo, reachAnly->InstToInfo, domain);
				F.print(errs(), &annot);
				return false;
			}
	...
	RegisterPass<ReachDef> X("reach", "reach");
