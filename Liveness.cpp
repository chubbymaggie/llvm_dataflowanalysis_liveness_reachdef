...
namespace {
	...
	class Liveness : public IDFA<llvm::Value *>, public FunctionPass {
		public:
			static char ID;
			Liveness() : IDFA<llvm::Value *>(), FunctionPass(ID) {
			}
			...
			virtual bool runOnFunction(Function &F) {
				...
				IDFA<Value *>::analysis(domain, F, false, BBtoInfo, InstToInfo);
